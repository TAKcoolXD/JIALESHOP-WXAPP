...
var _cashier = _interopRequireDefault(__webpack_require__(/*! ./pages/settlement/cashier.vue */ 223));
// @ts-ignore
...
/* harmony import */ var _cashier_vue_vue_type_template_id_15dc6cd4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cashier.vue?vue&type=template&id=15dc6cd4& */ 224);
/* harmony import */ var _cashier_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cashier.vue?vue&type=script&lang=js& */ 226);
...
/* harmony import */ var _cashier_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cashier.vue?vue&type=style&index=0&lang=scss& */ 498);
...
try {
  components = {
    uCountDown: function () {
      return Promise.all(/*! import() | node-modules/uview-ui/components/u-count-down/u-count-down */[__webpack_require__.e("common/vendor"), __webpack_require__.e("node-modules/uview-ui/components/u-count-down/u-count-down")]).then(__webpack_require__.bind(null, /*! uview-ui/components/u-count-down/u-count-down.vue */ 500))
    },
    uIcon: function () {
...
var _default = exports.default = {
  ...
  onLoad: function onLoad(option) {
    ...
    uni.$u.http.get("cashier/orderInfo&orderId=".concat(option.orderId, "&client=MP-WEIXIN")).then(function (res) {
      ...
      if (res.status == 200) {
        // res.data.order.
        _this.pay_price = res.data.order.pay_price;
        _this.balance = res.data.personal.balance;
        _this.expirationTime = res.data.order.expirationTime;
        _this.remainingTime = _this.calculateRemainingTime(_this.expirationTime); // 计算剩余时间
      }
    });
  }
};
